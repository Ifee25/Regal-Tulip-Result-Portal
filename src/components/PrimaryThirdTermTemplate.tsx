...
type Props = { student_name: string; session: string; term: string; class_name: string; priorTermResults: { first?: AssessmentResult; second?: AssessmentResult }; onSubmit: (result: AssessmentResult) => Promise<void>; onCancel: () => void; initialResult?: AssessmentResult; readOnly?: boolean; draftKey?: string };
...
export default function PrimaryThirdTermTemplate({ student_name, session, term, class_name, priorTermResults, onSubmit, onCancel, initialResult, readOnly = false, draftKey }: Props) {
